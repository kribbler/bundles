				    ...
				    if($this->map_controls['wpgmp_direction_tab']==true)
		{
				    ...
				    $this->code.='<div id="wpgmp_dir_tab'.$this->map_id.'" style="'.$default_styles['hide_direction_tab'].'">
							<div class="wpgmp_direction_container">
								...
								<input id="fromloc'.$this->map_id.'" placeholder="'.__("Start Point",'wpgmp_google_map').'" type="text" class="input fromloc"><span class="wpgmp_mcurrent_loction" title="Take Current Location" style="margin-right: 0px; position: absolute;"></span>
								<input id="toloc'.$this->map_id.'" placeholder="'.__("End Point",'wpgmp_google_map').'" type="text" class="input toloc">
								</form>
								<select id="tmode"> 
