...
*}
							...
							<br />
							<input type="checkbox" id="is_set" {if $category->is_set} checked="checked"{/if} name="is_set" value="1" />
							<label for="is_set">Is product set</label>
							<br />
							<span class="quiet">All product can be added to basket with one click in this category</span>
							<br />
							...
							<br />
							<input class="textinput" type="text" name="keywords" value="{$category->keywords}" maxlength="255" style="width: 100%;" />
							<br />
