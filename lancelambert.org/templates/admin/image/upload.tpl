...
<head>
	...
	<script type="text/javascript" src="/resources/js/tiny_mce/utils/mctabs.js"></script>
	<script type="text/javascript" src="/resources/js/tiny_mce/utils/form_utils.js"></script>
	<script type="text/javascript" src="/resources/js/tiny_mce/utils/validate.js"></script>
	<script type="text/javascript" src="/resources/js/tiny_mce/utils/editable_selects.js"></script>
	<script type="text/javascript" src="/resources/js/tiny_mce/plugins/phpimage/js/image.js"></script>
	<link href="/resources/js/tiny_mce/plugins/phpimage/css/phpimage.css" rel="stylesheet" type="text/css" />
</head>
