	...
	<div class="post_content">
		...
		<fieldset class="ui-widget ui-widget-content ui-corner-all" style="width: 250px;">
			...
			<form method="get" action="/ProductAdmin/ProductList/">
				<input type="text" name="q" value="{$q}" onkeyup="$('#product_list').load('/ProductAdmin/AjaxProductList/1/?q='+ escape( $(this).val() ) );" />
				<input type="submit" value="Search" />
 			</form>
		</fieldset>
	
		<div style="float: left; width: 500px;" id="product_list">
