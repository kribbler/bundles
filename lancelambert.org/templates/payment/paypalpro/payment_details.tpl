	...
	<tr {if $error.acct} class="error"{/if}>
		...
		<td>
			<div style="position: relative;">
				<input type="text" name="acct" class="text required" value="{$payment_input->acct}" maxlength="16" />
