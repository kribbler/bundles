...
if(document.addEventListener ){ 
   ...
   aLoader = [
    { load: "includes/jquery-1.7.1.min.js"},
    { load: "includes/jquery.easing.1.3.js"},
    { load: "includes/edge.1.0.0.min.js"},
        {test: !hasJSON, yep:"includes/json2_min.js"},
          { load: "scripts/header.js"},
          { load: "scripts/headerActions.js"}];
