...
if(!isset($_GET['speaker'])){
 ...
 if (preg_match('#\.divinehosting.ca$#',$_SERVER['HTTP_HOST']))
 ...
 $page->setInformation("audio",$section,"right",$_GET['speaker']);
	?>
	<?php if($_GET['section']!='Conferences' && $_GET['speaker'] == 'Lance Lambert'): // additional languages removed 27.06.12 ?>
		<h3 class="audio-header-2">Download Transcripts in additional languages</h3>
		<h1 class="audioHeader">Mandarin</h1>
		<ul>
			<li><a href="/files/CHURCH AT LAODICEA - Mandarin.pdf" target="_blank">è€�åº•å˜‰æ•™æœƒ (ä¸­æ–‡ç‰ˆ)</a></li>
        </ul>
        ...
        <ul>
            ...
            <li><a href="/files/italian/2/Autorita della Bibbia.pdf" target="_blank">AutoritÃ  della Bibbia</a></li>
