...
class upsRate {
    ...
    function getRate($PostalCode,$dest_zip,$country,$service,$length,$width,$height,$weight) 
    {
		...
		curl_close($ch);
			...
			if( $params['RATINGSERVICESELECTIONRESPONSE']['RATEDSHIPMENT']['TOTALCHARGES']['MONETARYVALUE'] )
			{
