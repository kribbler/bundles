...
class Controller
{
	...
	public $lang = 'default';
	public $params = null;
	public $decoration = 'decoration.tpl';

	protected $second_chance = true;
	...
	public function __construct()
	{
		...
		$this->smarty->compile_dir = '/tmp/lance';//SMARTY_COMPILE_DIR;
		$this->smarty->template_dir = SMARTY_TEMPLATES_DIR;
//		$this->smarty->registerPlugin( 'block', 't', 'Controller::translate' );
		$this->smarty->compile_check = true;
		$this->smarty->caching = 0;
		$this->smarty->cache_dir = false;
