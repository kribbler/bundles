...
<body <?php body_class(); ?>>
	...
	<div class="page-wrapper <?php echo (is_front_page()) ? "" : "bubblish"; ?>">
				...
				<div class="container">
					<div class="row-fluid">
						...
						<ul class="header-link">
							...
							<li>/</li>
							<li><a href="https://www.facebook.com/groups/590091641128132/?ref=br_tf" target="_blank">MANTASTIC FORUM</a></li>
						</ul>
		...
		<header class="header header<?php echo $ht; ?>">
			...
			<div class="container">
				<div class="table-row">
					...
					<div id="header_top_text" class="header-top-text">
