...
function sr_top_ababdoned_products_export() {
    ...
    $abandoned_prod_data = json_decode(sr_get_abandoned_products($start_date,$end_date,get_woocommerce_currency_symbol(),get_option( 'woocommerce_price_num_decimals' ),'','','',$terms_post),true);
