...
function woocommerce_toggle_fields( type ) {
    ...
    if ( type == 'customer' ) {
        ...
        hide = ['.adjust_date_tr', '.always_send_tr', '.signup_description', '.product_description_tr', '.product_tr', '.category_tr', '.var_item_name', '.var_item_category', '.var_item_names', '.var_item_categories', '.var_item_name', '.var_item_category', '.interval_duration_date', '.var_order', '.custom_field_tr'];
