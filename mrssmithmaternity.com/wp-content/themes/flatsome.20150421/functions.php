...
function flatsome_scripts() {
	...
	/* main style */
	wp_enqueue_style( 'flatsome-style', get_stylesheet_uri(), array(), '1.7', 'all');	
	...
	wp_enqueue_script( 'flatsome-theme-js', get_template_directory_uri() .'/js/theme.js?v=1.7', array( 'jquery' ), '20120202', true );
...
/* Facebook meta tags */
if(!isset($flatsome_opt['facebook_meta']) && $flatsome_opt['facebook_meta'] || !is_front_page()) {
