			...
			ed.add({
				...
				onclick: function () {
					...
					if(id == "ux_banner_video") {
						tinyMCE.activeEditor.selection.setContent('[ux_banner  video_mp4="" video_ogv="" video_webm=""  bg="#000" height="300px" animation="fadeIn" text_align="center" text_pos="center"] <h1>Banner content</h1>[/ux_banner]');
					}
