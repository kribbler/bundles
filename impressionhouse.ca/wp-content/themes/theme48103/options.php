...
// ---------------------------------------------------------
			...
			$background_defaults = array(
				'color' => '#FFFFFF', 
				'image' => get_stylesheet_directory_uri().'/images/body.png', 
				'repeat' => 'repeat',
				'position' => 'top center',
				'attachment'=>'scroll'
			);
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '12px', 'lineheight' => '22px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#a9a9a9'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '23px', 'lineheight' => '28px', 'face' => 'Oswald', 'style' => 'bold', 'character'  => 'latin', 'color' => '#FFFFFF'));
			
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '21px', 'lineheight' => '25px', 'face' => 'Oswald', 'style' => 'bold', 'character'  => 'latin', 'color' => '#442d2d'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '19px', 'lineheight' => '23px', 'face' => 'Oswald', 'style' => 'bold', 'character'  => 'latin', 'color' => '#442d2d'));
			
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '17px', 'lineheight' => '20px', 'face' => 'Oswald', 'style' => 'bold', 'character'  => 'latin', 'color' => '#442d2d'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '15px', 'lineheight' => '18px', 'face' => 'Oswald', 'style' => 'bold', 'character'  => 'latin', 'color' => '#442d2d'));
								
			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '13px', 'lineheight' => '16px', 'face' => 'Oswald', 'style' => 'bold', 'character'  => 'latin', 'color' => '#442d2d'));
...
// ---------------------------------------------------------
		...
		$options['telephone'] = array("name" => __('Telephone', CURRENT_THEME),
					"desc" => __('Telephone number in the header', CURRENT_THEME),
					"id" => "telephone",
					"std" => "1-800-123-DATA",
					"type" => "text");
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '60px', 'lineheight' => '70px', 'face' => 'Oswald', 'style' => 'bold', 'character'  => 'latin', 'color' => '#442d2d'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '15px', 'lineheight' => '18px', 'face' => 'Oswald', 'style' => 'bold', 'character'  => 'latin', 'color' => '#FFFFFF'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#a9a9a9'));
return $options;
	}
}
?>