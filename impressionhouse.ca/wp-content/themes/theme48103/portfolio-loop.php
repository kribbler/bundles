			...
			<div class="filter-wrapper clearfix">
				<div class="pull-right">
					...
					<ul id="filters" class="filter nav nav-pills">
						...
						?>
						<li class="active" style="display:none !important"><a href="#" data-count="<?php echo $count_posts; ?>" data-filter><?php echo theme_locals("show_all"); ?></a></li>
						<?php 
							$filter_array = array();
							...
							foreach ($filter_array as $key => $value)
								if ( isset($value->count) ) {
									if ($countt==0)
										$currf='.term_id_'.$value->term_id.', .'.$key;
...
<ul id="portfolio-grid" data-currfilter="" class="filterable-portfolio thumbnails portfolio-<?php echo $cols; ?> loading" data-cols="<?php echo $cols; ?>">
