...
function optionsframework_fields() {
	...
	if ( isset( $optionsframework_settings['id'] ) && !empty($optionsframework_settings['id'] )) {
		$option_name = $optionsframework_settings['id'];
	}
	// HACK BY DANIEL ROTH TO Get options to show up saved in the back end.
	elseif ($optionsframework_settings['knownoptions'][0]){
		$option_name = $optionsframework_settings['knownoptions'][0];
	}
	// End of HACK BY DANIEL ROTH
	else {
