...
get_header('shop'); ?>
<?php if ($_SERVER['REMOTE_ADDR'] == '83.103.200.163') echo 'lol - archive product';?>
	<div class="container_12">
        ...
        <?php } ?>
            ...
            <?php } ?>
                ...
                <div class="category_header">
                    ...
                    <div id="change_search">Endre søk</div>
                    <?php
        ...
        <?php if ($archive_product_sidebar == "yes") { ?>  
            <?php if ( is_active_sidebar( 'widgets_product_listing' ) ) : ?>
                <div class="grid_3 pull_6" id="search_bar">
