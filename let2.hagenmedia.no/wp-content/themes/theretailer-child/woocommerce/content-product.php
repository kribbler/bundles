...
?>
	...
	<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
        ...
        <li class="product_item">
			...
			<?php /* hide product category by daniel            
            ...
            */?>
            ...
            <?php 
            $arsmodell = woocommerce_get_product_terms( $product->id, 'pa_arsmodell', 'names' );
            $kmstand = woocommerce_get_product_terms( $product->id, 'pa_kilometer', 'names' );
            ?>
            <p>Årsmodell: <b><?php echo implode('', $arsmodell)?></b></p>
            <p>Km.stand: <b><?php echo implode('', $kmstand)?></b></p>
