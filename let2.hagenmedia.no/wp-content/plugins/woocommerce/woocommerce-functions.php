 ...
 * @return void
 */
function woocommerce_kilometer_filter_init() {
	global $woocommerce;

	if ( is_active_widget( false, false, 'kilometer_filter', true ) && ! is_admin() ) {

		$suffix = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ? '' : '.min';

		wp_register_script( 'wc-kilometer-slider', $woocommerce->plugin_url() . '/assets/js/frontend/kilometer-slider' . $suffix . '.js', array( 'jquery-ui-slider' ), '1.6', true );

		add_filter( 'loop_shop_post_in', 'woocommerce_kilometer_filter' );
	}
}

add_action( 'init', 'woocommerce_kilometer_filter_init' );
 ...
 * @return array
 */
function woocommerce_kilometer_filter($filtered_posts) {
    global $wpdb;
 ...
 * @return void
 */
function woocommerce_year_filter_init() {
	global $woocommerce;

	if ( is_active_widget( false, false, 'year_filter', true ) && ! is_admin() ) {

		$suffix = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ? '' : '.min';

		wp_register_script( 'wc-year-slider', $woocommerce->plugin_url() . '/assets/js/frontend/year-slider' . $suffix . '.js', array( 'jquery-ui-slider' ), '1.6', true );

		add_filter( 'loop_shop_post_in', 'woocommerce_year_filter' );
	}
}

add_action( 'init', 'woocommerce_year_filter_init' );
 ...
 * @return array
 */
function woocommerce_year_filter($filtered_posts) {
    global $wpdb;
 ...
 * @return void
 */
function woocommerce_antalseter_filter_init() {
	global $woocommerce;

	if ( is_active_widget( false, false, 'antalseter_filter', true ) && ! is_admin() ) {

		$suffix = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ? '' : '.min';

		wp_register_script( 'wc-antalseter-slider', $woocommerce->plugin_url() . '/assets/js/frontend/antalseter-slider' . $suffix . '.js', array( 'jquery-ui-slider' ), '1.6', true );

		add_filter( 'loop_shop_post_in', 'woocommerce_antalseter_filter' );
	}
}

add_action( 'init', 'woocommerce_antalseter_filter_init' );
 ...
 * @return array
 */
function woocommerce_antalseter_filter($filtered_posts) {
    global $wpdb;
 ...
 * @return void
 */
function woocommerce_effekt_filter_init() {
	global $woocommerce;

	if ( is_active_widget( false, false, 'effekt_filter', true ) && ! is_admin() ) {

		$suffix = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ? '' : '.min';

		wp_register_script( 'wc-effekt-slider', $woocommerce->plugin_url() . '/assets/js/frontend/effekt-slider' . $suffix . '.js', array( 'jquery-ui-slider' ), '1.6', true );

		add_filter( 'loop_shop_post_in', 'woocommerce_effekt_filter' );
	}
}

add_action( 'init', 'woocommerce_effekt_filter_init' );
 ...
 * @return array
 */
function woocommerce_effekt_filter($filtered_posts) {
    global $wpdb;
