...
class Woocommerce {
	...
	function register_widgets() {
		...
		include_once( 'classes/widgets/class-wc-widget-kilometer-filter.php' );
		include_once( 'classes/widgets/class-wc-widget-year-filter.php' );
		include_once( 'classes/widgets/class-wc-widget-antalseter-filter.php' );
		include_once( 'classes/widgets/class-wc-widget-effekt-filter.php' );
