...
if ( ! function_exists( 'is_filtered' ) ) {
	...
	function is_filtered() {
		...
		return apply_filters( 'woocommerce_is_filtered', ( sizeof( $_chosen_attributes ) > 0 || ( isset( $_GET['max_price'] ) && isset( $_GET['min_price'] ) ) || ( isset( $_GET['max_kilometer'] ) && isset( $_GET['min_kilometer'] ) ) || ( isset( $_GET['max_year'] ) && isset( $_GET['min_year'] ) ) || ( isset( $_GET['max_antalseter'] ) && isset( $_GET['min_antalseter'] ) ) || ( isset( $_GET['max_effekt'] ) && isset( $_GET['min_effekt'] ) ) ) );
	}
}
