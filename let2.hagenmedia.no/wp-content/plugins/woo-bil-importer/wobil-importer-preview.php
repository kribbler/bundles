<?php 
    ...
    if(isset($_POST['import_csv_url']) && strlen($_POST['import_csv_url']) > 0) {
        ...
        if(!file_exists($upload_dir)) {
            $error_messages[] = sprintf( __( 'Could not create upload directory %s.', 'wobil-importer' ), $upload_dir );
        }
        ...
        if($uploaded_file_ext != 'csv') {
            $error_messages[] = sprintf( __( 'The file extension %s is not allowed.', 'wobil-importer' ), $uploaded_file_ext );
            ...
            if(move_uploaded_file($_FILES['import_csv']['tmp_name'], $uploaded_file_path)) {
                ...
                $error_messages[] = sprintf( __( '%s returned false!', 'wobil-importer' ), '<code>' . move_uploaded_file() . '</code>' );
            }
        }
    }
    ...
    if($file_path) {
        ...
        if ( $handle !== FALSE ) {
            ...
            $error_messages[] = __( 'Could not open file.', 'wobil-importer' );
        }
        ...
        if($row_count == 0)
            $error_messages[] = __( 'No data to import.', 'wobil-importer' );
    ...
    $col_mapping_options = array(
        'do_not_import' => array(
            'label' => __( 'Do Not Import', 'wobil-importer' ),
            'mapping_hints' => array()),
        'post_title' => array(
            'label' => __( 'Name', 'wobil-importer' ),
            'mapping_hints' => array('title', 'product name')),
        'post_status' => array(
            'label' => __( 'Status (Valid: publish/draft/trash/[more in Codex])', 'wobil-importer' ),
            'mapping_hints' => array('status', 'product status', 'post status')),
        'post_content' => array(
            'label' => __( 'Description', 'wobil-importer' ),
            'mapping_hints' => array('desc', 'content')),
        'post_excerpt' => array(
            'label' => __( 'Short Description', 'wobil-importer' ),
            'mapping_hints' => array('short desc', 'excerpt')),
        '_regular_price' => array(
            'label' => __( 'Regular Price', 'wobil-importer' ),
            'mapping_hints' => array('price', '_price', 'msrp')),
        '_sale_price' => array(
            'label' => __( 'Sale Price', 'wobil-importer' ),
            'mapping_hints' => array()),
        '_tax_status' => array(
            'label' => __( 'Tax Status (Valid: taxable/shipping/none)', 'wobil-importer' ),
            'mapping_hints' => array('tax status', 'taxable')),
        '_tax_class' => array(
            'label' => __( 'Tax Class', 'wobil-importer' ),
            'mapping_hints' => array()),
        '_visibility' => array(
            'label' => __( 'Visibility (Valid: visible/catalog/search/hidden)', 'wobil-importer' ),
            'mapping_hints' => array('visibility', 'visible')),
        '_featured' => array(
            'label' => __( 'Featured (Valid: yes/no)', 'wobil-importer' ),
            'mapping_hints' => array('featured')),
        '_weight' => array(
            'label' => __( 'Weight', 'wobil-importer' ),
            'mapping_hints' => array('wt')),
   		'_the_link' => array(
            'label' => __( 'Do Not Import', 'wobil-importer' ),
            'mapping_hints' => array('_the_link')),
        '_length' => array(
            'label' => __( 'Length', 'wobil-importer' ),
            'mapping_hints' => array('l')),
        '_width' => array(
            'label' => __( 'Width', 'wobil-importer' ),
            'mapping_hints' => array('w')),
        '_height' => array(
            'label' => __( 'Height', 'wobil-importer' ),
            'mapping_hints' => array('h')),
        '_sku' => array(
            'label' => __( 'SKU', 'wobil-importer' ),
            'mapping_hints' => array()),
        '_downloadable' => array(
            'label' => __( 'Downloadable (Valid: yes/no)', 'wobil-importer' ),
            'mapping_hints' => array('downloadable')),
        '_virtual' => array(
            'label' => __( 'Virtual (Valid: yes/no)', 'wobil-importer' ),
            'mapping_hints' => array('virtual')),
        '_stock' => array(
            'label' => __( 'Stock', 'wobil-importer' ),
            'mapping_hints' => array('qty', 'quantity')),
        '_stock_status' => array(
            'label' => __( 'Stock Status (Valid: instock/outofstock)', 'wobil-importer' ),
            'mapping_hints' => array('stock status', 'in stock')),
        '_backorders' => array(
            'label' => __( 'Backorders (Valid: yes/no/notify)', 'wobil-importer' ),
            'mapping_hints' => array('backorders')),
        '_manage_stock' => array(
            'label' => __( 'Manage Stock (Valid: yes/no)', 'wobil-importer' ),
            'mapping_hints' => array('manage stock')),
        '_product_type' => array(
            'label' => __( 'Product Type (Valid: simple/variable/grouped/external)', 'wobil-importer' ),
            'mapping_hints' => array('product type', 'type')),
        'product_cat_by_name' => array(
            'label' => __( 'Categories By Name (Separated by "|")', 'wobil-importer' ),
            'mapping_hints' => array('category', 'categories', 'product category', 'product categories', 'product_cat')),
        'product_cat_by_id' => array(
            'label' => __( 'Categories By ID (Separated by "|")', 'wobil-importer' ),
            'mapping_hints' => array()),
        'product_tag_by_name' => array(
            'label' => __( 'Tags By Name (Separated by "|")', 'wobil-importer' ),
            'mapping_hints' => array('tag', 'tags', 'product tag', 'product tags', 'product_tag')),
        'product_tag_by_id' => array(
            'label' => __( 'Tags By ID (Separated by "|")', 'wobil-importer' ),
            'mapping_hints' => array()),
        'custom_field' => array(
            'label' => __( 'Custom Field (Set Name Below)', 'wobil-importer' ),
            'mapping_hints' => array('custom field', 'custom')),
        'product_image_by_url' => array(
            'label' => __( 'Images (By URL, Separated by "|")', 'wobil-importer' ),
            'mapping_hints' => array('image', 'images', 'image url', 'image urls', 'product image url', 'product image urls')),
        'product_image_by_path' => array(
            'label' => __( 'Images (By Local File Path, Separated by "|")', 'wobil-importer' ),
            'mapping_hints' => array('image path', 'image paths', 'product image path', 'product image paths')),
        '_button_text' => array(
            'label' => __( 'Button Text (External Product Only)', 'wobil-importer' ),
            'mapping_hints' => array('button text')),
        '_product_url' => array(
            'label' => __( 'Product URL (External Product Only)', 'wobil-importer' ),
            'mapping_hints' => array('product url', 'url')),
        '_file_path' => array(
            'label' => __( 'File Path (Downloadable Product Only)', 'wobil-importer' ),
            'mapping_hints' => array('file path', 'file')),
        '_download_expiry' => array(
            'label' => __( 'Download Expiration (in Days)', 'wobil-importer' ),
            'mapping_hints' => array('download expiration', 'download expiry')),
        '_download_limit' => array(
            'label' => __( 'Download Limit (Number of Downloads)', 'wobil-importer' ),
            'mapping_hints' => array('download limit', 'number of downloads')),
        'post_meta' => array(
            'label' => __( 'Post Meta', 'wobil-importer' ),
...
<div class="woo_product_importer_wrapper wrap">
    ...
    <h2><?php _e( 'WoBIL Product Importer &raquo; Preview', 'wobil-importer' ); ?></h2>
    ...
    <?php if($row_count > 0): ?>
        <form enctype="multipart/form-data" method="post" action="<?php echo get_admin_url().'tools.php?page=wobil-importer&action=result'; ?>">
            ...
            <p>
                <button class="button-primary" id="submit_form" type="submit"><?php _e( 'Import', 'wobil-importer' ); ?></button>
            </p>
            ...
            <table id="import_data_preview" class="wp-list-table widefat fixed pages" cellspacing="0">
                <thead>
                    <?php if(intval($_POST['header_row']) == 1): ?>
                        <tr class="header_row">
                            <th colspan="<?php echo ($show_import_checkboxes) ? sizeof($header_row) + 2 : sizeof($header_row) + 1; ?>">
                            	<?php _e( 'CSV Header Row', 'wobil-importer' ); ?><br />
                    ...
                    <tr>
                        <?php if($show_import_checkboxes): ?>
							<th>Duplicate</th>
                            <th class="narrow"><?php _e( 'Import?', 'wobil-importer' ); ?></th>
                        <?php endif; ?>
                        <?php
                            reset($import_data);
                        ...
                        ?>
                            <th>
                                <div class="map_to_settings">
                                	...
                                	endforeach;?>
                                    <?php _e( 'Map to:', 'wobil-importer' ); ?> <select id="s_<?php echo $header_value?>" name="map_to[<?php echo $key; ?>]" class="map_to">
                                        <?php foreach($col_mapping_options as $value => $meta): ?>
                                ...
                                <div class="custom_field_settings field_settings">
                                    <h4><?php _e( 'Custom Field Settings', 'wobil-importer' ); ?></h4>
                                    <p>
                                        <label for="custom_field_name_<?php echo $key; ?>"><?php _e( 'Name', 'wobil-importer' ); ?></label>
                                    ...
                                    <p>
                                        ...
                                        <label for="custom_field_visible_<?php echo $key; ?>"><?php _e( 'Visible?', 'wobil-importer' ); ?></label>
                                    </p>
                                </div>
                                <div class="product_image_settings field_settings">
                                    <h4><?php _e( 'Image Settings', 'wobil-importer' ); ?></h4>
                                    <p>
                                        ...
                                        <label for="product_image_set_featured_<?php echo $key; ?>"><?php _e( 'Set First Image as Featured', 'wobil-importer' ); ?></label>
                                    </p>
                                    <p>
                                        ...
                                        <label for="product_image_skip_duplicates_<?php echo $key; ?>"><?php _e( 'Skip Duplicate Images', 'wobil-importer' ); ?></label>
                                    </p>
                                </div>
                                <div class="post_meta_settings field_settings">
                                    <h4><?php _e( 'Post Meta Settings', 'wobil-importer' ); ?></h4>
                                    <p>
                                        <label for="post_meta_key_<?php echo $key; ?>"><?php _e( 'Meta Key', 'wobil-importer' ); ?></label>
	...
	$('#check_for_duplicates').click(function(){
		$('.check_duplicate').each(function(){
			...
			$.ajax({
				url: 		ajaxurl,
				data:		{
					'action': 'wobil-importer-check-duplicate',
					'sku': sku
				},
				type:		'POST',
