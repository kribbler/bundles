...
<div class="woo_product_importer_wrapper wrap">
    ...
    <h2><?php _e( 'WoBIL Product Importer &raquo; Results', 'wobil-importer' ); ?></h2>
    ...
    <div id="import_status">
        <div id="import_in_progress">
            <img src="<?php echo plugin_dir_url(__FILE__); ?>img/ajax-loader.gif"
                alt="<?php _( 'Importing. Please do not close this window or click your browser\'s stop button.', 'wobil-importer' ); ?>"
                title="<?php _e( 'Importing. Please do not close this window or click your browser\'s stop button.', 'wobil-importer' ); ?>">

            <strong><?php _e( 'Importing. Please do not close this window or click your browser\'s stop button.', 'wobil-importer' ); ?></strong>
        </div>
        <div id="import_complete">
            <img src="<?php echo plugin_dir_url(__FILE__); ?>img/complete.png"
                alt="<?php _e( 'Import complete!', 'wobil-importer' ); ?>"
                title="<?php _e( 'Import complete!', 'wobil-importer' ); ?>">
            <strong><?php _e( 'Import Complete! Results below.', 'wobil-importer' ); ?></strong>
        </div>

        <table>
            <tbody>
                <tr>
                    <th><?php _e( 'Processed', 'wobil-importer' ); ?></th>
                    <td id="insert_count">0</td>
                </tr>
                <tr>
                    <th><?php _e( 'Remainin', 'wobil-importer' ); ?>g</th>
                    <td id="remaining_count"><?php echo $_POST['row_count']; ?></td>
                </tr>
                <tr>
                    <th><?php _e( 'Total', 'wobil-importer' ); ?></th>
    ...
    <table id="inserted_rows" class="wp-list-table widefat fixed pages" cellspacing="0">
        <thead>
            <tr>
                ...
                <th style="width: 80px;"><?php _e( 'CSV Row', 'wobil-importer' ); ?></th>
                <th style="width: 80px;"><?php _e( 'New Post ID', 'wobil-importer' ); ?></th>
                <th><?php _e( 'Name', 'wobil-importer' ); ?></th>
                <th><?php _e( 'SKU', 'wobil-importer' ); ?></th>
                <th style="width: 120px;"><?php _e( 'Price', 'wobil-importer' ); ?></th>
                <th><?php _e( 'Result', 'wobil-importer' ); ?></th>
            </tr>
        </thead>
        <tbody><!-- rows inserted via AJAX --></tbody>
    </table>

    <p><a id="show_debug" href="#" class="button"><?php _e( 'Show Raw AJAX Responses', 'wobil-importer' ); ?></a></p>
