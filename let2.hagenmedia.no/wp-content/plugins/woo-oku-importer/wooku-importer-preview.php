...
<div class="woo_product_importer_wrapper wrap">
    ...
    <h2><?php _e( 'WoOKU Product Importer &raquo; Preview', 'wooku-importer' ); ?></h2>
    ...
    <?php if($row_count > 0): ?>
        <form enctype="multipart/form-data" method="post" action="<?php echo get_admin_url().'tools.php?page=wooku-importer&action=result'; ?>">
            ...
            <p>
                <button class="button-primary" id="submit_form" type="submit"><?php _e( 'Import', 'wooku-importer' ); ?></button>
            </p>
