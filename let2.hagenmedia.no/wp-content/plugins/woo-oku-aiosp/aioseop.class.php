...
//			$keywords =	$this->get_unique_keywords($keywords);
			...
			//begin by daniel
			if ($metaset['keyword']) $keywords = $metaset['keyword'];
			//end by daniel
...
// Thank you, Yoast de Valk, for much of this code.		
	...
	//		$title = trim($title);
			...
			/* begin by daniel */
			global $wp_query;
			$metaset = check_seo_query_vars($wp_query->query_vars);
			if ($metaset['title']) $title = $metaset['title'];
			// end by daniel
...
<?php } ?>		
	...
	function admin_menu() {
		...
		add_submenu_page('tools.php', __('Wooku All in One SEO', 'all_in_one_seo_pack'), __('Wooku All in One SEO', 'all_in_one_seo_pack'), 'manage_options', $file, array($this, 'options_panel'));
	}
...
?>
	...
	<div class="wrap">
		...
		<h2><?php echo 'Wooku - '; _e('All in One SEO Plugin Options', 'all_in_one_seo_pack'); ?></h2>
