...
$for_hire = get_post_meta( $post->ID, 'for_hire', true );
//used to check if !$product->is_in_stock() ........
if ($for_hire && ! $product->is_purchasable()){?>
	<div class="cart-wrap clearfix">
		...
		<div class="cart-bottom clearfix<?php  if ( 'yes' == $product->sold_individually ) :?> lpd-sold_individually<?php endif; ?><?php if($catalog_type){?> lpd-sold_individually<?php }?>">
			<a href="<?php echo get_site_url();?>/survey-equipment-hire/" class="single_add_to_cart_button btn btn-primary a_button">Hire Now</a>
			<?php
			//if (function_exists("add_email_inquiry_button"))
				echo WC_Email_Inquiry_Hook_Filter::add_email_inquiry_button($product->id, 'single');
			?>
		</div>
	</div>
<?php }
		...
		<div class="cart-wrap clearfix">
		 	...
		 	<div class="cart-bottom clearfix<?php  if ( 'yes' == $product->sold_individually ) :?> lpd-sold_individually<?php endif; ?><?php if($catalog_type){?> lpd-sold_individually<?php }?>">
				...
				<?php if(!$catalog_type){?>
			 	...
			 	<?php } ?>
			 	<?php 
			 	//line bellow commented by daniel!
			 	//if (function_exists("add_email_inquiry_button"))
			 		echo WC_Email_Inquiry_Hook_Filter::add_email_inquiry_button($product->id, 'single');
			 	?>
			 	<!--<a href="#" class="single_add_to_cart_button btn btn-primary a_button">Enquire Now</a>-->
		 	</div>
