	...
	<div itemscope itemtype="<?php echo woocommerce_get_product_schema(); ?>" id="product-<?php the_ID(); ?>" <?php post_class($classes); ?>>
		...
		<div class="row">
			...
			<div class="col-md-6 product-content">
				...
				<div style="display: none" class="lpd-rating-navigation clearfix<?php if($product_page_a_type){?> cre-animate<?php }?>"<?php if($product_page_a_type){ echo $animation_att;}?>>
					<?php
				...
				<div class="lpd-rating-navigation clearfix">
					<div class="cart-bottom clearfix">
						<h1 itemprop="name" class="product_title entry-title some-on-top"><?php the_title(); ?></h1>
						<div class="d_price"><?php global $post, $product;echo $product->get_price_html(); ?></div>
					</div>
				</div>
				<?php
					/**
