...
<div class="left-col">
  ...
  if(isset($_POST['submit']))
  {
    ...
    $good_captcha = $_SESSION["captcha"]["code"];
    $captcha = $_POST['code'];

    if ($captcha != $good_captcha) {
      echo "<p>Invalid Captcha code.</p>
      <a style='color: yellow' onclick='history.go(-1);' href='javascript:void(0);'>Please try again</a>";
    } else {
  $name=$_POST["name"];
$email=$_POST["email"];
...
$email_="paulk@kraftechhomes.com";
//$email_ = "daniel.oraca@gmail.com";
$title="Customer Service";

//$headers="From:".$name."<".$email.">";
$headers = "From:".$name."<".$email.">"."\r\nReply-to: ".$email."";

  if(mail($email_,$title,$message,$headers))
    {
