...
<?php 
	if(isset($_GET['deleteId'])&& $_GET['deleteId']!=""){
				...
				$tblimg		=  'tbl_firstfloormasters_img';
            ...
            while($data	=	mysql_fetch_assoc($msquery)){  ?>
                <tr height="40px" bgcolor="#FAE6BC" style="color:#000; font:normal 12px arial;">
					...
					<?php
					 ...
					 ?>
                    <img width="50px" src="image/FirstFloorMasters/<?php echo $img['imgname'];?>" />
                    
                    </td>
                    
                    <td align="center"><a href="editfirstfloor.php?editid=<?php echo $data['id'];?>& tbl=<?php echo $tbl;?>& val=<?php echo $_GET['val']; ?>">
                    <img src="image/img/b_edit.png" /></a></td>
                    <td align="center"><a onClick="return confirm('Are you sure you want to delete?')" href="listfirstfloor.php?deleteId=<?php echo $data['id'];?>& tbl=<?php echo $tbl;?>& val=<?php echo $_GET['val']; ?> ">
