...
if( !isset($_SESSION['username']) || $_SESSION['username']=='')
	...
	include("includes/config.php");
			...
			if(isset($_GET['deleteId'])&& $_GET['deleteId']!=""){
					...
					$delete="Delete from tbl_firstfloormasters_img where id=".$_GET['deleteId'];
					mysql_query($delete);
...
<div class="left-col"  style="width:900px;">
  ...
  <div class="form">
 <h2>First Floor Image Details</h2>
<h3><?php echo $succesms; ?></h3>
<?php 
		$selectImg	=	"select * from tbl_firstfloormasters_img where pretableId='".$_GET['id']."'";
...
<?php
		while($data	=	mysql_fetch_assoc($msquery)){?>		
            <tr height="40px" bgcolor="#FAE6BC" style="color:#000; font:normal 12px arial;">
                	<td height="80px"><img width="100px" src="image/FirstFloorMasters/<?php echo $data['imgname']; ?>" /></td>
                    <td align="center"><a onClick="return confirm('Are you sure you want to delete?')" href="updatefirstfloor.php?deleteId=<?php echo $data['id'];?>&updateimage=<?php echo $_GET['updateimage']; ?>&id=<?php echo $_GET['id']; ?>">
