	...
	if(isset($_POST['btnSubmit'])&& $_POST['btnSubmit']=="edit home"){		
			...
			if(isset($_POST['virtualtour']) && $_POST['virtualtour']=='File'){ 
					...
					if(isset($_FILES['filevirtualTour']['name']) && $_FILES['filevirtualTour']['name']!=''){
						...
						move_uploaded_file($_FILES['filevirtualTour']['tmp_name'],"videos/FirstFloorMasters/". $filevirtualTour);
			...
			if(empty($msg)){
				...
				$query		=	"update tbl_firstfloormasters set
				...
				if(!empty($_FILES['imageFiles']['name'])){
						...
						if($filename!=''){			
							...
							move_uploaded_file($_FILES['imageFiles']['tmp_name'][$i],"image/FirstFloorMasters/". $filename);

								$large_image_location = "image/FirstFloorMasters/". $filename ; 
						   ...
						   ///////////////////////////
						    ...
						    $inquery="insert into tbl_firstfloormasters_img	set pretableId	=	'".$insertId."', imgname =	'".$filename."', imagetext='".$imagetext."'";
...
<div class="left-col">
 ...
 <h2> Edit - First Floor Masters</h2>
...
<p style="padding-left:150px;"><a href="updatefirstfloor.php?updateimage=<?php echo $_GET['val'].'&id='.$editid; ?>">Edit old images</a></p>
