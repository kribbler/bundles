...
<?php
	...
	if(isset($_POST['btnSubmit'])&& $_POST['btnSubmit']=="Add"){		
			...
			if(empty($msg)){
				...
				$query		=	"insert into tbl_firstfloormasters set
...
<span style="display:none;" id="tourLink"><input style="min-width:250px;" type="text" name="filevirtualTourtext" value="" /></span></td>
