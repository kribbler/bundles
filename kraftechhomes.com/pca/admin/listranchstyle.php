            ...
            while($data	=	mysql_fetch_assoc($msquery)){  ?>
                ...
                <tr height="40px" bgcolor="#FAE6BC" style="color:#000; font:normal 12px arial;">
					...
					<?php
					 ...
					 ?>
                    <img width="50px" src="image/RanchStyles/<?php echo $img['imgname'];?>" />
                    
                    </td>
                    
                    <td align="center"><a href="editranchstyle.php?editid=<?php echo $data['id'];?>& tbl=<?php echo $tbl;?>& val=<?php echo $_GET['val']; ?>">
                    <img src="image/img/b_edit.png" /></a></td>
                    <td align="center"><a onClick="return confirm('Are you sure you want to delete?')" href="listranchstyle.php?deleteId=<?php echo $data['id'];?>& tbl=<?php echo $tbl;?>& val=<?php echo $_GET['val']; ?> ">
