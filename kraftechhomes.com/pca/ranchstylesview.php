...
<a href="admin/videos/RanchStyles/<?php echo $data['virtualTour']; ?>"><img src="images/virtual-tour.jpg" width="200" height="32" border="0" /></a>
...
<div class="gallery-btn"><a href="contact.php"><img src="images/request.jpg" width="200" height="32" border="0" /></a></div>
  ...
  <div class="gallery-btn"><a href="ranchstyles.php"><img src="images/backtogallery.jpg" width="200" height="32" border="0" /></a></div>
...
<?php 
 					...
 					$imgquery 		= 	"select * from  $tblimg where pretableId='".$data['id']."' ORDER BY img_order ASC LIMIT 1";  
 ...
 <div style="display:block;">   				
                    ...
                    <a href="admin/image/RanchStyles/<?php echo $imgname['imgname']; ?>"  rel="lightbox[roadtrip]"  title="<?php echo $imgname['imagetext']; ?>" >

                    <img src="admin/image/RanchStyles/<?php echo $imgname['imgname']; ?>" width="465" height="344" alt="" />
...
<?php	
		    ...
		    $imgquery 		= 	"select * from  $tblimg where pretableId='".$data['id']."' ORDER BY img_order ASC LIMIT 1,30";  
			...
			while($imgname		=	mysql_fetch_assoc($msimgquery)){  ?>
 			...
 			<div  class="slide-img1">   				
                    ...
                    <img src="admin/image/RanchStyles/<?php echo $imgname['imgname']; ?>" width="100" height="100" alt="" />
