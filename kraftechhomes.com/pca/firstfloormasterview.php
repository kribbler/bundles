...
<div class="ourhome"><img width="666" height="65" src="images/first-floor-master.jpg"></div>
...
<?php
  $string = $data['virtualTour'];
    ...
    if ($pos === false) { ?>
<a href="admin/videos/FirstFloorMasters/<?php echo $data['virtualTour']; ?>"><img src="images/virtual-tour.jpg" width="200" height="32" border="0" /></a>
<?php     } else { ?>
...
<div class="gallery-btn"><a href="contact.php"><img src="images/request.jpg" width="200" height="32" border="0" /></a></div>
  <div class="gallery-btn"><a href="firstfloormaster.php"><img src="images/backtogallery.jpg" width="200" height="32" border="0" /></a></div>
</div>
...
<?php 
			...
			<div style="display:block;">   				
                    <a href="admin/image/FirstFloorMasters/<?php echo $imgname['imgname']; ?>"  rel="lightbox[roadtrip]"  title="<?php echo $imgname['imagetext']; ?>" >
                    <img src="admin/image/FirstFloorMasters/<?php echo $imgname['imgname']; ?>" width="465" height="344" alt="" />
                    </a>
           </div>
        <?php  }?>
		...
		<?php	
			...
			while($imgname		=	mysql_fetch_assoc($msimgquery)){  ?>
 			<div  class="slide-img1">   				
                    <a href="admin/image/FirstFloorMasters/<?php echo $imgname['imgname']; ?>"  rel="lightbox[roadtrip]" title="<?php echo $imgname['imagetext']; ?>" >
                    <img src="admin/image/FirstFloorMasters/<?php echo $imgname['imgname']; ?>" width="100" height="100" alt="" />
                    </a>
           </div>
           <?php   } ?> 
    </div>
