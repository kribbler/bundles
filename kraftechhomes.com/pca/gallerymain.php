...
<div class="home-pic">
                ...
                <img style="margin-left:3px;" src="admin/image/SecondFloorMasters/<?php echo $imgname['imgname']; ?>" width="170" height="130" border="0" /></a></div>
...
<?php
  ...
  $string = $data['virtualTour'];
    ...
    if ($pos === false) { ?>
      ...
      <a href="admin/videos/SecondFloorMasters/<?php echo $data['virtualTour']; ?>"><img src="images/virtual-tour-gallery.jpg" width="194" height="26" border="0" /></a>
