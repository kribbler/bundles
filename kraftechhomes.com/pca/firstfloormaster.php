...
echo '<div class="pic-hold">';
	$_GET['folder']= 'First Floor Masters';
...
<div class="home-pic">
					...
					?>
                <a href="firstfloormasterview.php?viewid=<?php echo $data['id'];?>&tbl=<?php echo $tbl; ?>">
                <img style="margin-left:3px;" src="admin/image/FirstFloorMasters/<?php echo $imgname['imgname']; ?>" width="170" height="130" border="0" /></a></div>
                <div class="pic-text">
...
<div class="viewbtn"><a href="firstfloormasterview.php?viewid=<?php echo $data['id'];?>&tbl=<?php echo $tbl; ?>"><img src="images/viewdetails.jpg" width="194" height="26" border="0" /></a></div>
...
<?php
  $string = $data['virtualTour'];
    ...
    if ($pos === false) { ?>
<a href="admin/videos/FirstFloorMasters/<?php echo $data['virtualTour']; ?>"><img src="images/virtual-tour-gallery.jpg" width="194" height="26" border="0" /></a>
<?php     } else { ?>
