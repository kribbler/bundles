...
<head>
<meta name="msvalidate.01" content="17CA0ABC55F67516A574A040873CE0E6" />
<meta name="google-site-verification" content="msHxJ8dijfmUm_9gx8zSqeJLP1XStgc71mqwvGGunYY" />
...
<body <?php body_class(); ?>>
	...
	<?php if (etheme_get_option('fixed_nav') || 1==1): ?>
	...
	<div class="header-wrapper<?php if(etheme_get_option('fade_animation')): ?> fade-in delay1<?php endif; ?> header-type-<?php echo $ht; ?>">
		...
		<header id="desktop_header" class="header header<?php echo $ht; ?>">
			<div class="container">
				<div class="row-fluid upper-side">
						<!--
						...
						<div class="top_block">
							...
							<div class="a-right">
								<a href="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" class="shopping-cart-link___" >
									<img src="<?php echo get_stylesheet_directory_uri();?>/images/icon-shopping-cart.png" />
									
								</a>
								<?php if ($woocommerce->cart->cart_contents_count) { ?>
									<a class="header_count" href="<?php echo $woocommerce->cart->get_cart_url(); ?>"><span class="items"><?php echo $woocommerce->cart->cart_contents_count; ?> </a>
								<?php } ?>
							</div>
							...
							<!--
							<?php if (etheme_get_option('search_form')): ?>
								<div class="search hide-input__ a-right">
				...
				<div class="row-fluid lower_side">
					<div class="span4">
						<?php etheme_logo(); ?>
					</div>
					<div class="span5">
						<div class="row-fluid">
							<div class="span6 h-left">
								<div id="h-left-inside" class="padding-20">
		...
		<header class="header header<?php echo $ht; ?>" style="display: none">
