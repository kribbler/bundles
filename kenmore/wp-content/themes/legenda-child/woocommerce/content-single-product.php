...
<div itemscope itemtype="http://schema.org/Product" id="product-<?php the_ID(); ?>" <?php post_class('single-product-page'); ?>>
	...
	<div class="row product-info sidebar-position-<?php echo $position; ?> responsive-sidebar-<?php echo $responsive; ?>">
		...
		<div class="span5 product_meta">
			...
			<?php
           	$call_only = get_post_meta( get_the_ID(), 'call_only', true );
           	if ($call_only){ ?>
           	<div style="width:100%; margin-bottom:20px; display: block; clear: both;">
           		<a class="etheme-simple-product__ filled big font2 single_add_to_cart_button button big alt" href="<?php echo site_url();?>/call-for-price-contact-form/">Call For Price</a>

           		<!--<a class="etheme-simple-product filled big font2" href="<?php echo site_url();?>/contact/">Call For Price</a>-->
           	</div>
           	<div class="clear"></div>
           	<?php } else { ?>
