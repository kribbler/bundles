...
<div id="readmore_wrapper">
    ...
    <div id="readmore_1">
        <label>Show in content: </label>
        <input id="content" type="checkbox" value="content" />
    </div>     
</div>
...
function getValue() { 
    ...
    var values = '';
    var select_video, video_id, featured, content;

    select_video = document.getElementById('select_video').value;
    video_id = document.getElementById('video_id').value;
    featured = document.getElementById('featured').checked;
    content = document.getElementById('content').checked;

    if(select_video=='youtube') {
        values = '[youtube featured="' + featured + '" content="' + content + '"]' + video_id + '[/youtube]<br>';
    } else if(select_video=='vimeo') {
        values = '[vimeo featured="' + featured + '" content="' + content + '"]' + video_id + '[/vimeo]<br>';
    } else if(select_video=='dailymotion') {
        values = '[dailymotion]' + video_id + '[/dailymotion]<br>';
    }
