				...
				foreach ( $post['postmeta'] as $meta ) {
					...
					if ( $key ) {
                        ...
                        if(isset($post['pages'])) {
                            ...
                            foreach($post['pages'] as $pages) {

                                if($pages['id']) { 

                                    $wpdb->query("INSERT INTO " . $wpdb->prefix . "envoo_pages (id, type, details) VALUES ('".$pages['id']."', '".$pages['type']."', '".$post_id . $pages['details']."')");
                        ...
                        if(isset($post['front_page'])) {

                            global $wpdb;

                            global $wp_rewrite;

                            foreach($post['front_page'] as $front_page) {
                        ...
                        if(isset($post['blog_page'])) {

                            global $wpdb;

                            foreach($post['blog_page'] as $blog_page) {
