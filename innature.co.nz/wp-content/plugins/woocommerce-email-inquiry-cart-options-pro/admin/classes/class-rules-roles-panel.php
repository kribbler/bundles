...
class WC_Email_Inquiry_Rules_Roles_Panel
{
	...
	public static function panel_page() {
		...
		if (isset($_REQUEST['bt_save_settings'])) {
			...
			if (!isset($customized_settings['hide_price'])) $customized_settings['hide_price'] = 'no';
			if (!isset($customized_settings['role_apply_hide_price'])) $customized_settings['role_apply_hide_price'] = array();
			...
			if ( isset($_POST['wc_email_inquiry_reset_products_options']) && $_POST['wc_email_inquiry_reset_products_options'] == 'yes') 
		...
		<table class="form-table">
            ...
            <tr valign="top">
		    	...
		    	<td class="forminp">
                	<label><input type="checkbox" <?php checked( $hide_price, 'yes' ); ?> value="yes" id="hide_price" name="<?php echo $option_name; ?>[hide_price]" /> <span class=""><?php _e('Yes. Applies to all users who are not logged in.', 'wc_email_inquiry');?></span></label>
				</td>
			</tr>
            <tr valign="top">
		    	...
		    	<td class="forminp">                    
                    ...
                    <?php foreach ($roles as $key => $val) { ?>
                        <option value="<?php echo $key; ?>" <?php selected( in_array($key, (array) $role_apply_hide_price), true ); ?>><?php esc_attr_e( stripslashes( $val) ); ?></option>
                    <?php } ?>
                    </select>
				</td>
			</tr>
            <tr valign="top">
		    	...
		    	<td class="forminp">
                	<label><input type="checkbox" value="yes" id="wc_email_inquiry_reset_products_options" name="wc_email_inquiry_reset_products_options" /> <span class=""><?php _e('Check to reset ALL products that have custom Roles & Rules settings to the settings made above.', 'wc_email_inquiry');?></span></label>
				</td>
			</tr>
		</table>
