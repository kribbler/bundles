...
class WC_Email_Inquiry_Hook_Filter
{
	...
	public static function shop_before_hide_price($template_name, $template_path, $located) {
		global $post;
		global $product;
	...
	public static function shop_after_hide_price($template_name, $template_path, $located) {
		global $post;
		global $product;
		if ($template_name == 'loop/price.php' || $template_name == 'single-product/price.php') {
			$product_id = $product->id;
	...
	public static function wc_email_inquiry_popup() {
		...
		if ( $wc_email_inquiry_email_options['inquiry_send_copy'] == 'no') $wc_email_inquiry_send_copy = false;
...
<div class="wc_email_inquiry_form <?php echo $wc_email_inquiry_contact_form_class; ?>">
    ...
    <?php echo WC_Email_Inquiry_Functions::get_product_information( $product_id, 1, 100, 100, 'wc_email_inquiry_product_image_small'); ?>
	<div class="wc_email_inquiry_content" id="wc_email_inquiry_content_<?php echo $product_id; ?>">
        ...
        <div class="wc_email_inquiry_field">
            ...
            <label class="wc_email_inquiry_send_copy"><input type="checkbox" name="send_copy" id="send_copy_<?php echo $product_id; ?>" value="1" checked="checked" /> <?php _e('Send a copy of this email to myself.', 'wc_email_inquiry'); ?></label>
            <?php } ?>
...
(function($){
	$(function(){
		...
		?>
			...
			$.prettyPhoto.open(ajax_url+"?action=wc_email_inquiry_popup&product_id="+product_id+"&security=<?php echo $wc_email_inquiry_popup; ?>&ajax=true&width=600&height=480", "", "");
		<?php } else { ?>
