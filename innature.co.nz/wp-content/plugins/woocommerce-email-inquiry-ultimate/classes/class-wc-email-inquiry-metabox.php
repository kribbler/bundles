...
class WC_Email_Inquiry_MetaBox
{
	...
	public static function the_meta_forms() {
		...
		if (!isset($contact_form_shortcode)) $contact_form_shortcode = esc_attr( $wc_email_inquiry_3rd_contact_form_settings['contact_form_shortcode'] );
        ...
        <table cellspacing="0" class="form-table">
			<tbody>
                ...
                <tr valign="top" class="button_type_button">
                    ...
                    <td class="forminp"><input type="text" name="_wc_email_inquiry_settings_custom[contact_form_shortcode]" id="contact_form_shortcode" value="<?php echo $contact_form_shortcode;?>" style="min-width:300px" /> 
                    </td>
               	</tr>
        	</tbody>
		</table>
        ...
        <table cellspacing="0" class="form-table">
			<tbody>
                ...
                <tr valign="top">
                    ...
                    <td class="forminp">
                    <label><input type="checkbox" name="_wc_email_inquiry_settings_custom[show_read_more_button_before_login]" id="wc_ei_show_read_more_button_before_login" value="yes" <?php checked( $show_read_more_button_before_login, 'yes' ); ?> /> <?php _e('ON', 'wc_email_inquiry'); ?></label>
                    </td>
               	</tr>
                <tr valign="top">
                    ...
                    <td class="forminp">
                    	<label><input class="wc_ei_rule_after_login" type="checkbox" name="_wc_email_inquiry_settings_custom[show_read_more_button_after_login]" id="wc_ei_show_read_more_button_after_login" value="yes" <?php checked( $show_read_more_button_after_login, 'yes' ); ?> /> <?php _e('ON', 'wc_email_inquiry'); ?></label>
                ...
                <tr valign="top">
                    ...
                    <td class="forminp"><input type="text" name="_wc_email_inquiry_settings_custom[read_more_text]" id="wc_ei_read_more_text" value="<?php echo $read_more_text;?>" style="min-width:300px" /> <p class="description"><?php echo __( '&lt;empty&gt; defaults to Global text', 'wc_email_inquiry' ); ?></p>
                    </td>
               	</tr>
			</tbody>
        </table>
	...
	public static function save_meta_boxes($post_id){
		...
		if ($post_type == 'product' && isset($_REQUEST['_wc_email_inquiry_settings_custom']) && $post_status != false  && $post_status != 'inherit') {
			...
			if ( !isset($wc_email_inquiry_settings_custom['show_read_more_button_before_login'] ) ) {
				$wc_email_inquiry_settings_custom['show_read_more_button_before_login'] = 'no' ;
			}
			if ( !isset($wc_email_inquiry_settings_custom['show_read_more_button_after_login'] ) ) {
				$wc_email_inquiry_settings_custom['show_read_more_button_after_login'] = 'no' ;
			}
			if ( !isset($wc_email_inquiry_settings_custom['role_apply_show_read_more'] ) ) {
				$wc_email_inquiry_settings_custom['role_apply_show_read_more'] = array() ;
			}
