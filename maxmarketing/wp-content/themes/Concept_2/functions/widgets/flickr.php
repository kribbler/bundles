...
class concept7_flickr extends WP_Widget {
	
	function concept7_flickr() {
		
		// define widget title and description
		$widget_ops = array('classname' => 'ht_flickr_widget',
							'description' => __( 'Get images from your Flickr account.','concept7') );
		// register the widget
		$this->WP_Widget('concept7_flickr', __('concept7 Flickr','concept7'), $widget_ops);
	...
	<?php _e('Flickr ID ','concept7'); ?>(<a href="http://www.idgettr.com" target="_blank">idGettr</a>):</label>
...
add_action('widgets_init', create_function('', 'return register_widget("concept7_flickr");'));	
?>