...
<div id="classic-post-wrapper" class="wrapper boxed-wrapper">
	...
	<div class="container">
    	<div class="row">
        	<h4 style="text-align:center;"><?php _e('Text here and hit Enter if you want to try another search:','concept7')?></h4>
        ...
        <div class="row">
        	<div id="classic-posts" class="span8">
                ...
                <div id="classsic-post" <?php post_class(); ?>>
                    ...
                    <p class="post-headline">Lorem ipsum dolor sit amet, consectetur adipisic elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
