...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=445263695583698";
...
<?php responsive_header(); // before header hook ?>
	<div id="header">
		...
		<div class="top-widget header-hours"><?php echo get_post_content_by_slug( 'header-hours' ); ?></div>
		<?php get_sidebar( 'top' ); ?>
