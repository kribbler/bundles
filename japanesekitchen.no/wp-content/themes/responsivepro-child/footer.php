...
<div id="footer" class="clearfix">
	...
	<div id="footer-wrapper">
		<div id="footer-info">
			<?php echo get_post_content_by_slug( 'follow-us-on-facebook' ); ?>
			<?php echo get_post_content_by_slug( 'footer-address' ); ?>
		</div>
		<div class="grid col-940" style="display:none">
...
<script>
        var images = [
              "http://sushidelight.no/dev/wp-content/uploads/2013/11/sushi-background.jpg"
