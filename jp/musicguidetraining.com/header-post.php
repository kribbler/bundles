...
<title>NEO Mag HTML5 Responsive Theme</title>
<!--CUSTOM CSS-->
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="left-box">
              <ul>
                <li>1 hour ago - Learn To Strum Your Guitar Like a Pro with Jamorama Learn Guitar Product</li>
              </ul>
            </div>
          </div>
          <div class="col-md-6">
            <div class="right-box">
              <div class="cp-header-search-box" style="display: none">
