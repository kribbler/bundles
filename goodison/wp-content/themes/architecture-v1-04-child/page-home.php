...
<?php get_header(); ?>
	...
	<div class="page-wrapper single-page <?php echo $sidebar_array['sidebar_class']; ?>">
		<?php
			...
			// Page Item Part
			if(!empty($gdl_page_xml) && !post_password_required() && 1==2){
		...
		<div class="container">
			<?php
				if ($_SERVER['REMOTE_ADDR'] == '127.0.0.1') 
					...
					echo do_shortcode('[content_block id=3283 ]'); 
			?>
		</div>
	</div>	
		...
		<div class="container">
			<?php
				if ($_SERVER['REMOTE_ADDR'] == '127.0.0.1') 
					...
					echo do_shortcode('[content_block id=3285 ]'); 
			?>
			<?php
		...
		<div class="container">
			<?php
				if ($_SERVER['REMOTE_ADDR'] == '127.0.0.1') 
					...
					echo do_shortcode('[content_block id=3287 ]'); 
			?>
			<?php
			if(!empty($gdl_page_xml) && !post_password_required() ){
				$page_xml_val = new DOMDocument();
		...
		<div class="container">
			<?php
				if ($_SERVER['REMOTE_ADDR'] == '127.0.0.1') 
					...
					echo do_shortcode('[content_block id=3289 ]'); 
			?>
		</div>
	</div>
		...
		<div class="container">
			<?php
				if ($_SERVER['REMOTE_ADDR'] == '127.0.0.1') 
					...
					echo do_shortcode('[content_block id=3291 ]'); 
			?>
		</div>
	</div>
...
<div> <!-- special div for ending content wrapper by DANIEL-->
<?php get_footer(); ?>