...
function shopifiq_register_required_plugins() {
    ...
    $plugins = array(
        array(
            'name' => 'WooSlider', 
            'slug' => 'wooslider', 
            'source' => 'http://anpsthemes.com/shopifiq/wp-content/themes/shopifiq/admin-functions/plugins/wooslider.zip', 
            'required' => false,
            'version' => '',
        ...
        array(
            'name' => 'woocommerce', 
            'slug' => 'woocommerce', 
            'source' => 'http://anpsthemes.com/shopifiq/wp-content/themes/shopifiq/admin-functions/plugins/woocommerce.1.6.6.zip', 
            'required' => true,
            'version' => '',
            'force_activation' => false, 
            'force_deactivation' => false, 
