			...
			foreach ($customer_orders as $customer_order) :
				...
				?><tr class="order">
					...
					<td class="order-actions" style="text-align:right; white-space:nowrap;">
						...
						<a style="display: block" href="<?php echo esc_url( add_query_arg('order', $order->id, get_permalink(woocommerce_get_page_id('view_order'))) ); ?>" class="button medium button-style1"><?php _e('View', 'woocommerce'); ?></a>
