<form action="admin-post.php" method="post">
    ...
    <p><a href="http://tri.be/shop/wordpress-wootickets/?utm_source=woocommerce&utm_medium=wordpress-admin&utm_campaign=followup-emails-plugin" target="_blank"><?php _e('WooTickets', 'wc_followup_emails'); ?></a></p>       
