...
<?php   
	...
	if( isset($data[0]->type) ) {
		$parent = get_page_by_title( $data[0]->type );
	}
...
<div class="box portfolio-pagination jquery-pagination">
    <div>
        ...
        <a><?php echo "<img src='" . get_stylesheet_directory_uri() . "/images/arrow_left.png' class='previous' />"; ?></a>
        ...
        ?></span>
        <a><?php echo "<img src='" . get_stylesheet_directory_uri() . "/images/arrow_right.png' class='next' />"; ?></a>
...
<!-- Start Load page content -->
	<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>		
        ...
        <?php if ( isset($right_sidebar[0]) && $right_sidebar[0] != "0" ): ?>
            <aside class="sidebar sidebar-right clearfix <?php echo str_replace(' ', '', $right_sidebar[0]);?>"><?php get_sidebar( dynamic_sidebar( $right_sidebar[0]) ); ?></aside>  
        <?php endif; ?>
