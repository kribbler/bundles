	...
	public static function panel_page() {
		...
		<table class="form-table">
            <tr valign="top">
		    	...
		    	<td class="forminp">
                	<label><input type="checkbox" value="yes" id="wc_email_inquiry_reset_products_options" name="wc_email_inquiry_reset_products_options" /> <span class=""><?php _e('Check to reset ALL products that have custom Button or Hyperlink Text settings to the settings made above.', 'wc_email_inquiry');?></span></label>
				</td>
			</tr>
		</table>
	<?php
