	...
	public static function panel_page() {
		...
		<table class="form-table">
            ...
            <tr valign="top">
				...
				<td class="forminp">
					<input type="text" class="colorpick" value="<?php esc_attr_e( stripslashes( $inquiry_contact_button_bg_colour ) );?>" style="width:120px;" id="inquiry_contact_button_bg_colour" name="<?php echo $option_name; ?>[inquiry_contact_button_bg_colour]" /> <span class="description"><?php _e('Button colour. Default', 'wc_email_inquiry');?> <code><?php echo $default_settings['inquiry_contact_button_bg_colour']; ?></code></span>
			...
			<tr valign="top">
				<th class="titledesc" scope="rpw"><label for="inquiry_contact_button_bg_colour_from"><?php _e('Button Background Colour Gradient From','wc_email_inquiry'); ?></label></th>
				<td class="forminp">
					<input type="text" class="colorpick" value="<?php esc_attr_e( stripslashes( $inquiry_contact_button_bg_colour_from ) );?>" style="width:120px;" id="inquiry_contact_button_bg_colour_from" name="<?php echo $option_name; ?>[inquiry_contact_button_bg_colour_from]" /> <span class="description"><?php _e('Default', 'wc_email_inquiry');?> <code><?php echo $default_settings['inquiry_contact_button_bg_colour_from']; ?></code></span>
			...
			<tr valign="top">
				<th class="titledesc" scope="rpw"><label for="inquiry_contact_button_bg_colour_to"><?php _e('Button Background Colour Gradient To','wc_email_inquiry'); ?></label></th>
				<td class="forminp">
					<input type="text" class="colorpick" value="<?php esc_attr_e( stripslashes( $inquiry_contact_button_bg_colour_to ) );?>" style="width:120px;" id="inquiry_contact_button_bg_colour_to" name="<?php echo $option_name; ?>[inquiry_contact_button_bg_colour_to]" /> <span class="description"><?php _e('Default', 'wc_email_inquiry');?> <code><?php echo $default_settings['inquiry_contact_button_bg_colour_to']; ?></code></span>
			...
			<tr valign="top">
				...
				<td class="forminp">
					<select class="chzn-select" style="width:120px;" id="inquiry_contact_button_border_size" name="<?php echo $option_name; ?>[inquiry_contact_button_border_size]">
			...
			<tr>
				...
				<td class="forminp">
					<select class="chzn-select" style="width:120px;" id="inquiry_contact_button_border_style" name="<?php echo $option_name; ?>[inquiry_contact_button_border_style]">
			...
			<tr valign="top">
				...
				<td class="forminp">
					<input type="text" class="colorpick" value="<?php esc_attr_e( stripslashes( $inquiry_contact_button_border_colour ) );?>" style="width:120px;" id="inquiry_contact_button_border_colour" name="<?php echo $option_name; ?>[inquiry_contact_button_border_colour]" /> <span class="description"><?php _e('Border colour. Default', 'wc_email_inquiry');?> <code><?php echo $default_settings['inquiry_contact_button_border_colour']; ?></code></span>
			...
			<tr valign="top">
				...
				<td class="forminp">
                    <label><input type="radio" name="<?php echo $option_name; ?>[inquiry_contact_button_rounded_corner]" value="rounded" checked="checked" /> <?php _e('Rounded Corners','wc_email_inquiry'); ?></label> <span class="description">(<?php _e('Default', 'wc_email_inquiry');?>)</span> &nbsp;&nbsp;&nbsp;&nbsp;
                    <label><?php _e('Rounded Value','wc_email_inquiry'); ?></label> <input type="text" name="<?php echo $option_name; ?>[inquiry_contact_button_rounded_value]" value="<?php esc_attr_e( stripslashes( $inquiry_contact_button_rounded_value) );?>" style="width:120px;" />px <span class="description"><?php _e('Default', 'wc_email_inquiry');?> <code><?php echo $default_settings['inquiry_contact_button_rounded_value']; ?></code>px</span>
                    <br />
                    <label><input type="radio" name="<?php echo $option_name; ?>[inquiry_contact_button_rounded_corner]" <?php checked( $inquiry_contact_button_rounded_corner, 'square' ); ?> value="square" /> <?php _e('Square Corners','wc_email_inquiry'); ?></label>
				</td>
			</tr>
			<tr>
				<th class="titledesc" scope="row"><label for="inquiry_contact_button_font"><?php _e('Button Font', 'wc_email_inquiry');?></label></th>
				<td class="forminp">
					<select class="chzn-select" style="width:120px;" id="inquiry_contact_button_font" name="<?php echo $option_name; ?>[inquiry_contact_button_font]">
			...
			<tr>
				...
				<td class="forminp">
					<select class="chzn-select" style="width:120px;" id="inquiry_contact_button_font_size" name="<?php echo $option_name; ?>[inquiry_contact_button_font_size]">
						<option value="" selected="selected"><?php _e('Select Size', 'wc_email_inquiry');?></option>
                        <?php for( $i = 9 ; $i <= 40 ; $i++ ){ ?>
			...
			<tr>
				...
				<td class="forminp">
					<select class="chzn-select" style="width:120px;" id="inquiry_contact_button_font_style" name="<?php echo $option_name; ?>[inquiry_contact_button_font_style]">
			...
			<tr valign="top">
				...
				<td class="forminp">
					<input type="text" class="colorpick" name="<?php echo $option_name; ?>[inquiry_contact_button_font_colour]" id="inquiry_contact_button_font_colour" value="<?php esc_attr_e( stripslashes( $inquiry_contact_button_font_colour ) );?>" style="width:120px;" /> <span class="description"><?php _e('Default', 'wc_email_inquiry');?> <code><?php echo $default_settings['inquiry_contact_button_font_colour'] ?></code></span>
            ...
            <tr valign="top">
		    	...
		    	<td class="forminp">                    
                    <input type="text" value="<?php esc_attr_e( stripslashes( $inquiry_contact_button_class ) ); ?>" name="<?php echo $option_name; ?>[inquiry_contact_button_class]" id="inquiry_contact_button_class" style="width:300px;"  /> <span class="description"><?php _e('Enter your own button CSS class', 'wc_email_inquiry');?></span>
				</td>
			</tr>
            <tr valign="top">
		    	<th class="titledesc" scope="row"><label for="inquiry_contact_form_class"><?php _e( 'Form CSS Class', 'wc_email_inquiry' );?></label></th>
		    	<td class="forminp">                    
                    <input type="text" value="<?php esc_attr_e( stripslashes( $inquiry_contact_form_class ) ); ?>" name="<?php echo $option_name; ?>[inquiry_contact_form_class]" id="inquiry_contact_form_class" style="width:300px;"  /> <span class="description"><?php _e('&lt;empty&gt; for default or enter custom form CSS', 'wc_email_inquiry');?></span>
				</td>
			</tr>
            <tr valign="top">
