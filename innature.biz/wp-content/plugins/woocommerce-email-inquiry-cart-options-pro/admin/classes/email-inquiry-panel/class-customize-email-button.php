...
class WC_Email_Inquiry_Customize_Email_Button
{
	...
	public static function get_settings() {
		...
		$customized_settings = get_option('wc_email_inquiry_customize_email_button');
		if ( !is_array($customized_settings) ) $customized_settings = array();
		$default_settings = WC_Email_Inquiry_Customize_Email_Button::get_settings_default();
		...
		$wc_email_inquiry_customize_email_button = $customized_settings;
	...
	public static function panel_page() {
		...
		<table class="form-table">
            <tr valign="top">
		    	...
		    	<td class="forminp">                    
                    <input type="text" value="<?php esc_attr_e( stripslashes( $inquiry_text_before ) ); ?>" name="<?php echo $option_name; ?>[inquiry_text_before]" id="inquiry_text_before" style="width:300px;"  /> <span class="description"><?php _e("&lt;empty&gt; for default 'no text' or add text to prepent link text", 'wc_email_inquiry');?></span>
				</td>
			</tr>
            <tr valign="top">
		    	<th class="titledesc" scope="row"><label for="inquiry_hyperlink_text"><?php _e( 'Hyperlink text', 'wc_email_inquiry' );?></label></th>
		    	<td class="forminp">                    
                    <input type="text" value="<?php esc_attr_e( stripslashes( $inquiry_hyperlink_text ) ); ?>" name="<?php echo $option_name; ?>[inquiry_hyperlink_text]" id="inquiry_hyperlink_text" style="width:300px;"  /> <span class="description"><?php _e("&lt;empty&gt; for default 'Click Here' or your own text", 'wc_email_inquiry');?></span>
				</td>
			</tr>
            <tr valign="top">
		    	<th class="titledesc" scope="row"><label for="inquiry_trailing_text"><?php _e( 'Trailing text', 'wc_email_inquiry' );?></label></th>
		    	<td class="forminp">                    
                    <input type="text" value="<?php esc_attr_e( stripslashes( $inquiry_trailing_text ) ); ?>" name="<?php echo $option_name; ?>[inquiry_trailing_text]" id="inquiry_trailing_text" style="width:300px;"  /> <span class="description"><?php _e("&lt;empty&gt; for default 'no text' or add text to trail linked text", 'wc_email_inquiry');?></span>
				</td>
			</tr>
		</table>
		...
		<table class="form-table">
            <tr valign="top">
		    	...
		    	<td class="forminp">                    
                    <input type="text" value="<?php esc_attr_e( stripslashes( $inquiry_button_title ) ); ?>" name="<?php echo $option_name; ?>[inquiry_button_title]" id="inquiry_button_title" style="width:300px;"  /> <span class="description"><?php _e("&lt;empty&gt; for default 'Product Enquiry' or enter text", 'wc_email_inquiry');?></span>
				</td>
			</tr>
            <tr valign="top">
			...
			<tr valign="top">
				<th class="titledesc" scope="rpw"><label for="inquiry_button_bg_colour_from"><?php _e('Button Background Colour Gradient From','wc_email_inquiry'); ?></label></th>
				<td class="forminp">
			...
			<tr valign="top">
				<th class="titledesc" scope="rpw"><label for="inquiry_button_bg_colour_to"><?php _e('Button Background Colour Gradient To','wc_email_inquiry'); ?></label></th>
				<td class="forminp">
			...
			<tr valign="top">
				...
				<td class="forminp">
                    <label><input type="radio" name="<?php echo $option_name; ?>[inquiry_button_rounded_corner]" value="rounded" checked="checked" /> <?php _e('Rounded Corners','wc_email_inquiry'); ?></label> <span class="description">(<?php _e('Default', 'wc_email_inquiry');?>)</span> &nbsp;&nbsp;&nbsp;&nbsp;
                    <label><?php _e('Rounded Value','wc_email_inquiry'); ?></label> <input type="text" name="<?php echo $option_name; ?>[inquiry_button_rounded_value]" value="<?php esc_attr_e( stripslashes( $inquiry_button_rounded_value) );?>" style="width:120px;" />px <span class="description"><?php _e('Default', 'wc_email_inquiry');?> <code><?php echo $default_settings['inquiry_button_rounded_value']; ?></code>px</span>
                    <br />
                    <label><input type="radio" name="<?php echo $option_name; ?>[inquiry_button_rounded_corner]" <?php checked( $inquiry_button_rounded_corner, 'square' ); ?> value="square" /> <?php _e('Square Corners','wc_email_inquiry'); ?></label>
				</td>
			</tr>
			<tr>
            ...
            <tr valign="top">
		    	...
		    	<td class="forminp">                    
                    <input type="text" value="<?php esc_attr_e( stripslashes( $inquiry_button_class ) ); ?>" name="<?php echo $option_name; ?>[inquiry_button_class]" id="inquiry_button_class" style="width:300px;"  /> <span class="description"><?php _e('Enter your own button CSS class', 'wc_email_inquiry');?></span>
				</td>
			</tr>
		</table>
	<?php
