...
{	
	...
	public static function plugin_extension() {
		...
		$html .= '<h3>'.__('Features', 'wc_email_inquiry').':</h3>';
		$html .= '<p><ul>';
		$html .= '<li>* '.__('Turn your WooCommerce Store into a Quote Generation machine.', 'wc_email_inquiry').'</li>';
		$html .= '<li>* '.__('B2B Orders - Turn WooCommerce into a virtual Business to business online ordering system.', 'wc_email_inquiry').'</li>';
		$html .= '<li>* '.__('Quotes and Orders created as WooCommerce Orders.', 'wc_email_inquiry').'</li>';
		$html .= '<li>* '.__('Manual Quotes - User submits items for a Quote and manually added and sent.', 'wc_email_inquiry').'</li>';
		$html .= '<li>* '.__('Auto Quotes - Customer receives system pricing as soon as Quote is submitted.', 'wc_email_inquiry').'</li>';
		$html .= '<li>* '.__('Full integration with your existing WooCommerce Store.', 'wc_email_inquiry').'</li>';
		$html .= '<li>* '.__('Customize the WooCommerce Templates from the plugins dashboard.', 'wc_email_inquiry').'</li>';
		$html .= '</ul></p>';
