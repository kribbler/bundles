...
class WC_EI_3RD_Contact_Form_Settings extends WC_Email_Inquiry_Admin_UI
{
	...
	public function after_save_settings() {
		...
		if ( isset( $_POST['bt_save_settings'] ) && ( in_array ( $_POST['wc_email_inquiry_3rd_contact_form_settings']['product_page_open_form_type'], array( 'new_page', 'new_page_same_window' ) ) || in_array ( $_POST['wc_email_inquiry_3rd_contact_form_settings']['category_page_open_form_type'], array( 'new_page', 'new_page_same_window' ) ) ) ) {
