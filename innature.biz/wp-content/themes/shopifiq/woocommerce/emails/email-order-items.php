...
foreach ($items as $item) :
	...
	?>
	<tr>
		<td style="text-align:<?php echo $align; ?>; vertical-align:middle; border: 1px solid #eee;"><?php
		...
		?></td>
		<td style="text-align:<?php echo $align; ?>; vertical-align:middle; border: 1px solid #eee;"><?php echo $item['qty'] ;?></td>
		<td style="text-align:<?php echo $align; ?>; vertical-align:middle; border: 1px solid #eee;"><?php echo $order->get_formatted_line_subtotal( $item ); ?></td>
	</tr>

	<?php if ($show_purchase_note && $purchase_note = get_post_meta( $_product->id, '_purchase_note', true)) : ?>
		<tr>
			<td colspan="3" style="text-align:<?php echo $align; ?>; vertical-align:middle; border: 1px solid #eee;"><?php echo apply_filters('the_content', $purchase_note); ?></td>
		</tr>
	<?php endif; ?>
