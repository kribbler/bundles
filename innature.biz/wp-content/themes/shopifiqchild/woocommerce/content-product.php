...
<li class="product <?php
	...
	<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
		...
		<div class="product-image-holder test">
		...
		<?php 
			$permalinklink = get_permalink();
			
			if ($post->post_excerpt && $post->post_excerpt != "") echo '<div itemprop="description" class="desc">' . mb_substr ( strip_tags($post->post_excerpt), 0, get_option('shop_dec_len', '180')) . $len . '<a class="seemoreprod" href="'. $permalinklink.'">See more</a></div>'; ?>
