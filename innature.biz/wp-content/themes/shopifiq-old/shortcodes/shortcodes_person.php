...
function getValue() { 
    ...
    values = '[person name="' + name + '" picture="' + picture + '" title="' + title + '" facebook="' + facebook + '" twitter="' + twitter + '" linkedin="' + linkedin + '" dribbble="' + dribbble + '" google="' + google + '"]' + text + '[/person]<br>';
