...
<div id="readmore_wrapper">
    ...
    <div id="readmore_1">
        ...
        <input id="gradient_top" type="text" />
    </div>   
    
    <div id="readmore_1">
        <label>Gradient bottom: </label>
        <input id="gradient_bottom" type="text" />
    </div> 
...
function getValue() { 
    ...
    var values = '';
    var size, gradient_top, gradient_bottom, font_color, link, target, text;

    size = document.getElementById('size').value;
    gradient_top = document.getElementById('gradient_top').value;
    gradient_bottom = document.getElementById('gradient_bottom').value;
    font_color = document.getElementById('font_color').value;
    link = document.getElementById('link').value;
    target = document.getElementById('target').value;
    text = document.getElementById('text').value;
    
    values = '[button size="' + size + '" gradient_top="' + gradient_top + '" gradient_bottom="' + gradient_bottom + '" font_color="' + font_color + '" link="' + link + '" target="' + target + '"]' + text + '[/button]<br>';
