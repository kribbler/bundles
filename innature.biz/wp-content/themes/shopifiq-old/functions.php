...
function get_wooHeader() { ?>
    ...
    <?php if (is_plugin_active('woocommerce/woocommerce.php')): ?>
        ...
        <a href="/checkout" class="mycartcheckout"> Checkout </a>
        <?php if ( is_user_logged_in() ): ?>
            ...
            <?php
                ...
                if ( $myaccount_page_id ) {
                  ...
                  ?>
                    <a class="login-register right" href="<?php echo $logout_url; ?>"><?php _e("Logout", "shopifiq"); ?></a><span class="login-register-left right linkdivider"></span>
                  <?php
                }
            ?>

            <a class="login-register-left right" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('My account','woothemes'); ?>">
                <?php _e("My account", "shopifiq"); ?>
            </a>

        <?php else: ?>
            <a class="login-register right" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Login / Register','woothemes'); ?>">
                Register
            </a>
            <span class="login-register-left right linkdivider"></span>
            <a class="login-register-left right" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Login / Register','woothemes'); ?>">
                Login
            </a>  
    ...
    <span class="login-register-left right linkdivider"></span><a class="login-register-left right" href="/">Home</a>
	  ...
	  <div class="main-wrapper main-content clearfix">
		      ...
		      <?php if ( ! is_front_page() ): ?>
                    <?php if (get_option('breadcrumbs', '') == "on"): ?>
		      		  <div class="breadcrumbs clearfix <?php if(is_product()) echo "shopbread"?>"><?php echo the_breadcrumb(); ?></div>
                    <?php else: ?>
...
if (is_plugin_active('woocommerce/woocommerce.php')) {
    ...
    <?php if ( get_option('rtl', '') && get_option('rtl', '') == "on" ): ?>
        <a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'woothemes'); ?>"><?php _e('Cart', 'shopifiq'); echo " (" . $woocommerce->cart->cart_contents_count . ")"; ?></a>
    <?php else: ?>
        <a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'woothemes'); ?>"><?php _e('Cart', 'shopifiq'); echo " (" . $woocommerce->cart->cart_contents_count . ")"; ?></a>
    <?php endif; ?>
