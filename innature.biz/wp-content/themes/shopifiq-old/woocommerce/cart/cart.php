	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<input type="submit" class="checkout-button button alt" name="proceed" value="<?php _e('Proceed to Checkout ' . $arrow, 'woocommerce'); ?>" /> <input type="submit" class="button update-button" name="update_cart" value="<?php _e('Update Cart', 'woocommerce'); ?>" />
